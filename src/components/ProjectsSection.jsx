...
const PROJECTS = [
  {
    ...
    desc:  'Modern, responsive e-commerce web application featuring product catalog browsing, dynamic cart management, smooth checkout experience, and fast UI performance.',
    stack: ['React.js', 'JavaScript', 'HTML & CSS', 'Vercel Deployment'],
